  ...
  return (
    <div className="relative w-full md:w-8/12 ">
      ...
      <input
        ...
        className=" text-gray-700 w-full pl-3 pr-20 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-transparent focus:ring-2 focus:ring-primary-500 transition-all"
      />
      {term && (
